(function() {
  ...
  var css = [
    ...
    '.wdp-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;}',
    '.wdp-card{border:2px solid #3a3a4e;border-radius:8px;padding:6px;',
    ...
    '.wdp-card img{width:100%;height:auto;max-height:110px;object-fit:contain;border-radius:4px;',
    'background:#2a2a3e;}',
    '.wdp-card .wdp-card-name{font-size:12px;font-weight:bold;margin:4px 0 1px;}',
    '.wdp-card .wdp-card-desc{font-size:10px;color:#999;overflow:hidden;',
    ...
    'font-size:11px;color:#ccc;padding:2px 8px;border-radius:4px;margin:0 1px;}',
